...
def run(playwright: Playwright) -> None:
    ...
    # ---------------------8
    page.goto("http://localhost:5173/#/sensors?pageIndex=undefined")
    time.sleep(0.5)
    save_screenshot(page, "screenshot1")
    page.locator("body").press("Alt+s+4")
    time.sleep(0.5)
    save_screenshot(page, "screenshot2")
    page.get_by_text("Bluetooth").click()
    time.sleep(0.5)
    save_screenshot(page, "screenshot3")
    page.locator("div").filter(has_text=re.compile(r"^Лаборатория\(Биология\)$")).click()
    time.sleep(0.5)
    ...
    page.locator("div").filter(has_text=re.compile(r"^Датчик Т окр\.Отключен$")).get_by_role("button", name="Отключен").click()
    time.sleep(0.5)
    ...
    page.locator("div").filter(has_text=re.compile(r"^Датчик pH$")).click()
    time.sleep(0.5)
