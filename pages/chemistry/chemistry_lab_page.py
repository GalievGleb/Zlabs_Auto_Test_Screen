...
def run(playwright: Playwright) -> None:
    ...
    page.locator("div").filter(has_text=re.compile(r"^Лаборатория\(Химия\)$")).click()
    time.sleep(0.5)
    ...
    page.locator("div").filter(has_text=re.compile(r"^Датчик pHПодключен$")).get_by_role("button", name="Подключен").click()
    time.sleep(0.5)
    ...
    page.locator("div").filter(has_text=re.compile(r"^Датчик pHОтключен$")).get_by_role("button", name="Отключен").click()
    time.sleep(0.5)
    ...
    page.get_by_text("Датчик pH").click()
    time.sleep(0.5)
    save_screenshot(page, "screenshot11")
    page.get_by_text("Датчик электропроводимости").click()
    time.sleep(0.5)
    save_screenshot(page, "screenshot12")
    page.locator("div").filter(has_text=re.compile(r"^Настройки эксперимента$")).click()
    time.sleep(0.5)
    ...
    page.get_by_role("combobox", name="Интервал между записями:").select_option("20")
    time.sleep(0.5)
    save_screenshot(page, "screenshot33")
    page.get_by_role("combobox", name="Интервал между записями:").select_option("10")
    time.sleep(0.5)
    ...
    page.locator("div").filter(has_text=re.compile(r"^Датчик pHКалибровать$")).get_by_role("button", name="Калибровать").click()
    time.sleep(0.5)
    save_screenshot(page, "screenshot44")
    page.locator("span").filter(has_text="Калибровка датчика Датчик pH").get_by_role("button").click()
    time.sleep(0.5)
