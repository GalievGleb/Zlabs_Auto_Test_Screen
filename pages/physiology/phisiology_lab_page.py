...
def run(playwright: Playwright) -> None:
    ...
    elements = [
        ...
        page.get_by_text("Лаборатория(Физиология)"),
        page.get_by_role("navigation").get_by_text("Датчик темп. тела"),
        page.get_by_text("Датчик пульса"),
        page.get_by_text("Датчик частоты дыхания"),
